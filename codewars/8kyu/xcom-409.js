...
function travelDistance(avgSpeed, travelTime) {
  ...
  const travelKms   = travelNauticalMiles * NAUTICAL_MILE_TO_KM;
  
  return +travelKms.toFixed(2);
}

travelDistance(0, 0) // 0
travelDistance(600, 60) // 1111.2
travelDistance(800, 60) // 1481.6
travelDistance(621, 126) // 2415.19